...
<head>
    ...
    ?> 
    <link rel="stylesheet" type="text/css" href="<?php echo iN_HelpSecure($base_url, FILTER_VALIDATE_URL); ?>themes/<?php echo iN_HelpSecure($currentTheme); ?>/css/audioplayer.css">
</head>
<body>
...
<script type="text/javascript" src="<?php echo iN_HelpSecure($base_url, FILTER_VALIDATE_URL); ?>themes/<?php echo iN_HelpSecure($currentTheme); ?>/js/greenaudioplayer/audioplayer.js?v=12"></script>
