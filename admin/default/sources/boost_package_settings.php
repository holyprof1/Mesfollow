        ...
        <div class="i_admin_contents_wrapper column flex_">
            <?php
                ...
                if(isset($_GET['id'])){
                   ...
                   $checkBoostPlanIDExist = $iN->CheckBoostPlanExist($planID);
                   if(!empty($checkBoostPlanIDExist)){
                    include("contents/editBoostPackage.php");
                   }
                }else{
                   include("contents/boost_package_settings.php");
                }
            ?>
        </div>
    </div>
