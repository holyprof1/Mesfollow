        ...
        <div class="i_modal_content general_conf">
            ...
            <form enctype="multipart/form-data" method="post" id="newSocialSiteForm">
                    ...
                    <div class="irow_box_right">
                        <div class="i_checkbox_wrapper flex_ tabing_non_justify">
                            ...
                            <label class="el-switch el-switch-yellow" for="socialsitestatus">
                                <input type="checkbox" name="socialsitestatus" class="chmdAnnouncementStatus" id="socialsitestatus" <?php echo iN_HelpSecure($sData['status']) === 'yes' ? 'checked="checked"' : ''; ?> value="yes">
                                <span class="el-switch-style"></span>
                            </label>
                            <input type="hidden" name="socialsitestatus_hidden" class="socialsitestatus" value="<?php echo iN_HelpSecure($sData['status']) === 'yes' ? 'yes' : 'no'; ?>">
                ...
                <div class="i_modal_g_footer flex_">
                    <input type="hidden" name="f" value="editnewSocialSite">
...
<script type="text/javascript" src="<?php echo iN_HelpSecure($base_url);?>admin/<?php echo iN_HelpSecure($adminTheme);?>/js/editSocialSiteHandler.js?v=<?php echo iN_HelpSecure($version);?>" defer></script>
