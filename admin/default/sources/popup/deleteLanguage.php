    ...
    <div class="i_modal_in_in">
        <div class="i_modal_content">
            ...
            <div class="i_modal_g_header">
                <?php echo iN_HelpSecure($LANG['delete_language']); ?>
            ...
            <div class="i_delete_post_description column flex_">
                <?php echo iN_HelpSecure($LANG['delete_note_lang']); ?>
            </div>

            <!-- Modal Footer -->
            <div class="i_modal_g_footer flex_">
                <div class="alertBtnRight delete_lng transition" id="<?php echo iN_HelpSecure($langID); ?>">
