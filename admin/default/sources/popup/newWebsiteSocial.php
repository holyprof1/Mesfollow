    ...
    <div class="i_modal_in_in">
        <div class="i_modal_content general_conf">
            ...
            <form enctype="multipart/form-data" method="post" id="newSocialSiteForm">
                ...
                <div class="warning_wrapper papk_wraning box_not_padding_left_plus_ten"><?php echo iN_HelpSecure($LANG['please_use_svg_code']); ?></div>
                <div class="warning_wrapper warning_one box_not_padding_left_plus_ten"><?php echo iN_HelpSecure($LANG['full_for_register']); ?></div>

                <div class="i_modal_g_footer flex_">
                    <input type="hidden" name="f" value="newWebSocialSite">
...
<script src="<?php echo iN_HelpSecure($base_url); ?>admin/<?php echo iN_HelpSecure($adminTheme); ?>/js/newWebSocialSiteHandler.js?v=<?php echo iN_HelpSecure($version); ?>" defer></script>
</div> 