    ...
    <div class="i_modal_in_in">
        <div class="i_modal_content">
            ...
            <div class="i_modal_g_header">
                <?php echo iN_HelpSecure($LANG['delete_catt']); ?>
            ...
            <div class="i_delete_post_description">
                <?php echo iN_HelpSecure($LANG['sure_to_delete_catt']); ?>
            </div>

            <!-- Modal Footer -->
            <div class="i_modal_g_footer flex_">
                <div class="alertBtnRight delete_tcat transition" id="<?php echo iN_HelpSecure($postID); ?>">
