    ...
    <div class="i_modal_in_in">
        <div class="i_modal_content">
            ...
            <div class="i_modal_g_header">
                <?php echo iN_HelpSecure($LANG['delete_advertisement']); ?>
            ...
            <div class="i_delete_post_description">
                <?php echo iN_HelpSecure($LANG['are_you_sure_delete_ads']); ?>
            </div>

            <!-- Modal Footer -->
            <div class="i_modal_g_footer flex_">
                <div class="alertBtnRight del__ads transition" id="<?php echo iN_HelpSecure($planID); ?>">
