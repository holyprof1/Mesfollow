    ...
    <div class="i_modal_in_in">
        <div class="i_modal_content">
            ...
            <div class="i_modal_g_header">
                <?php echo iN_HelpSecure($LANG['delete_page']); ?>
            ...
            <div class="i_delete_post_description">
                <?php echo iN_HelpSecure($LANG['are_you_sure_want_to_delete_this_page']); ?>
            </div>

            <!-- Modal Footer -->
            <div class="i_modal_g_footer flex_">
                <div class="alertBtnRight delete_page transition" id="<?php echo iN_HelpSecure($postID); ?>">
