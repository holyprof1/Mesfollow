<div class="create_product_form">
    ...
    <div class="create_product_form_column flex_">
        <div class="input_title">
            ...
            <input type="text" id="pr_name" class="prc" placeholder="What are you offering?" value="<?php echo iN_HelpSecure($LANG['liveeventticket_ex_title']);?>">
        </div>
        ...
        <div class="input_file_form">
            ...
            <form id="uploadprform" class="options-form" method="post" enctype="multipart/form-data" action="<?php echo iN_HelpSecure($base_url).'requests/request.php';?>">
                <label class="i_pr_file" for="i_pr_file flex_ tabing">
                    <div class="i_pr_btn flex_ tabing   "><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('165'));?></div>
    ...
    <div class="create_product_form_column">
        ...
        <div class="col-textarea-box">
            <textarea class="col-textarea" id="pr_description" placeholder="<?php echo iN_HelpSecure($LANG['pr_description_placeholder']);?>"><?php echo iN_HelpSecure($LANG['liveeventticket_ex']);?></textarea>
        </div>
    </div>
    <!---->
    <!---->
...
<script type="text/javascript" src="<?php echo iN_HelpSecure($base_url);?>themes/<?php echo iN_HelpSecure($currentTheme);?>/js/liveeventticket.js?v=<?php echo iN_HelpSecure($version);?>"></script>