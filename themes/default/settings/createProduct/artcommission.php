<div class="create_product_form">
    ...
    <div class="create_product_form_column flex_">
        <div class="input_title">
            ...
            <input type="text" id="pr_name" class="prc" placeholder="What are you offering?" value="<?php echo iN_HelpSecure($LANG['artcommissions_title_ex']);?>">
        </div>
    ...
    <div class="create_product_form_column">
        ...
        <div class="col-textarea-box">
            <textarea class="col-textarea" id="pr_description" placeholder="<?php echo iN_HelpSecure($LANG['pr_description_placeholder']);?>"><?php echo iN_HelpSecure($LANG['artcommissions_ex_desc']);?></textarea>
        </div>
    </div>
    <!---->
    <!---->
...
<script type="text/javascript" src="<?php echo iN_HelpSecure($base_url);?>themes/<?php echo iN_HelpSecure($currentTheme);?>/js/artcommission.js?v=<?php echo iN_HelpSecure($version);?>"></script>