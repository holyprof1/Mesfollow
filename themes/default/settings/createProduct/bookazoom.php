...
<script type="text/javascript" src="<?php echo iN_HelpSecure($base_url);?>themes/<?php echo iN_HelpSecure($currentTheme);?>/js/bookazoom.js?v=<?php echo iN_HelpSecure($version);?>"></script>