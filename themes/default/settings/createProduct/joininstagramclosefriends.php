<div class="create_product_form">
    ...
    <div class="create_product_form_column flex_">
        <div class="input_title">
            ...
            <input type="text" id="pr_name" class="prc" placeholder="What are you offering?" value="<?php echo iN_HelpSecure($LANG['joininstagramclosefriends_title_ex']);?>">
        </div>
    ...
    <div class="create_product_form_column flex_">
        ...
        <form id="tupprloadform" class="options-form flex_ dcontent optional_width" method="post" enctype="multipart/form-data" action="<?php echo iN_HelpSecure($base_url).'requests/request.php';?>">
    ...
    <div class="create_product_form_column">
        ...
        <div class="col-textarea-box">
            <textarea class="col-textarea" id="pr_description" placeholder="<?php echo iN_HelpSecure($LANG['pr_description_placeholder']);?>"><?php echo iN_HelpSecure($LANG['joininstagramclosefriends_desc_ex']);?></textarea>
        </div>
    </div>
    <!---->
    <!---->
    ...
    <div class="create_product_form_column padding_bottom_zero">
        ...
        <div class="i_set_subscription_fee_box padding_zero">
            ...
            <div class="i_set_subscription_fee limitslots padding_zero">
...
<script type="text/javascript" src="<?php echo iN_HelpSecure($base_url);?>themes/<?php echo iN_HelpSecure($currentTheme);?>/js/joininstagramclosefriends.js?v=<?php echo iN_HelpSecure($version);?>"></script>