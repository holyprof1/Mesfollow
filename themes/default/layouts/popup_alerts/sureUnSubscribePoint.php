<div class="i_modal_bg_in" role="dialog" aria-modal="true" aria-labelledby="finishSubscriptionPromptTitle">
    <!--SHARE-->
    <div class="i_modal_in_in">
        <div class="i_modal_content">
            <!-- Modal Header -->
            <div class="i_modal_g_header" id="finishSubscriptionPromptTitle">
            ...
            <div class="i_modal_g_footer">
                <div class="alertBtnRight unSubPNow transition"
