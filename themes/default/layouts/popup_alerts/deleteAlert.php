<div class="i_modal_bg_in" role="dialog" aria-modal="true" aria-labelledby="deletePostModalTitle">
    <!--SHARE-->
    <div class="i_modal_in_in">
        <div class="i_modal_content">
            <!-- Modal Header -->
            <div class="i_modal_g_header" id="deletePostModalTitle">
            ...
            <div class="i_delete_post_description">
                <?php echo iN_HelpSecure($LANG['delete_post_alert_note']); ?>
            </div>

            <!-- Modal Footer -->
            <div class="i_modal_g_footer">
                <div class="alertBtnRight yes-del transition"
