...
if (isset($_POST) && count($_POST) > 0 ) {
    ...
    if ($validation === true) {
        ...
        } elseif ($paymentOption == 'instamojo' || $paymentOption == 'paystack' || $paymentOption == 'iyzico' || $paymentOption == 'paypal' || $paymentOption == 'stripe' || $paymentOption == 'authorize-net' || $paymentOption == 'bitpay' || $paymentOption == 'mercadopago' || $paymentOption == 'mollie') {
