      ...
      <td align="center" valign="top">
        <table class="mobile-shell" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="container">
              <!-- Header -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" class="hedar">
                <tr>
                  <td class="p30-15">
                    <table width="100%">
                      <tr>
              ...
              <table width="100%">
                <tr>
                  <td align="center"><img src="https://media1.giphy.com/media/JLNeZFX4ct6hO/giphy.gif" alt=""></td>
                </tr>
              </table>
              <!-- End Hero Image -->
              ...
              <table width="100%" bgcolor="#ffffff">
                <tr>
                  <td class="p30-15">
                    <table width="100%">
                      <tr><td class="h1 pb25">$youEarnMoney</td></tr>
                      <tr><td class="text-center pb25">$someoneBoughtYourPost</td></tr>
                      <tr>
                        <td align="center">
                          <table>
                            <tr>
